...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  useEffect(() => {
    // Error reporting removed — replace with your preferred logger if needed.
  }, [error]);
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Bryant Melliza — Software Developer" },
      {
        ...
        content:
          "Engineering scalable digital solutions. React · Next.js · Prisma · AI Automation.",
      },
...
function RootComponent() {
  ...
  useEffect(() => {
    fetch("https://zenuxbry.app.n8n.cloud/webhook-test/fe9a0d1d-484c-4997-97b7-0fb419dc91bb", {
      method: "POST",
