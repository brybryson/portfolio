export const projects = [
    {
        ...
        title: "Solace Point",
        year: "June 2026",
        description: "Full-stack digital insurance platform built for OneNetworx Marketing, driving client acquisition and boosting sales performance with a high-conversion, premium interface.",
        image: "images/solacepoint/heropage.png",
        tags: ["React JS", "Tailwind CSS", "Vite"],
        category: "Web Application",
        quote: "Premium digital experience driving sales and client acquisition for non-life insurance.",
        slideshow: ["images/solacepoint/heropage.png"],
        challenge: "Developing a high-impact digital platform for OneNetworx Marketing to replace traditional, offline insurance pipelines and accelerate lead generation for non-life insurance products.",
        solution: "Engineered a full-stack, client-facing sales portal featuring real-time automated quote generation, secure database registration, and a high-fidelity user interface that converts visitors into active policyholders.",
        features: [
